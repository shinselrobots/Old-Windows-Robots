...
if(FALSE)
  set(ecl_time_lite_SOURCE_PREFIX C:/work/ecl/src/ecl_lite/ecl_time_lite)
  set(ecl_time_lite_DEVEL_PREFIX C:/work/ecl/devel)
  ...
  set(ecl_time_lite_INSTALL_PREFIX C:/opt/overlay/groovy/x86)
...
if(NOT "C:/opt/overlay/groovy/x86/include" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    ...
    elseif(IS_DIRECTORY C:/opt/overlay/groovy/x86/${idir})
      ...
      message(FATAL_ERROR "Project 'ecl_time_lite' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/opt/overlay/groovy/x86/${idir}'.  Ask the maintainer 'Daniel Stonier <d.stonier@gmail.com>' to fix it.")
    endif()
    _list_append_unique(ecl_time_lite_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "ecl_time_lite")
...
foreach(depend ${depends})
  ...
  list(APPEND ecl_time_lite_LIBRARIES ${${ecl_time_lite_dep}_LIBRARIES})
...
if(ecl_time_lite_LIBRARIES)
  _remove_duplicate_libraries(ecl_time_lite_LIBRARIES ecl_time_lite_LIBRARIES)
endif()
