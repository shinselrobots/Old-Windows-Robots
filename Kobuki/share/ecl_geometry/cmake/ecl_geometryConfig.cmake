...
if(FALSE)
  set(ecl_geometry_SOURCE_PREFIX C:/work/ecl/src/ecl_core/ecl_geometry)
  set(ecl_geometry_DEVEL_PREFIX C:/work/ecl/devel)
  ...
  set(ecl_geometry_INSTALL_PREFIX C:/opt/overlay/groovy/x86)
...
if(NOT "C:/opt/overlay/groovy/x86/include" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    ...
    elseif(IS_DIRECTORY C:/opt/overlay/groovy/x86/${idir})
      ...
      message(FATAL_ERROR "Project 'ecl_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/opt/overlay/groovy/x86/${idir}'.  Ask the maintainer 'Daniel Stonier <d.stonier@gmail.com>' to fix it.")
    endif()
...
set(depends "ecl_config;ecl_type_traits;ecl_containers;ecl_formatters;ecl_linear_algebra;ecl_exceptions;ecl_math;ecl_mpl")
foreach(depend ${depends})
  ...
  list(APPEND ecl_geometry_LIBRARIES ${${ecl_geometry_dep}_LIBRARIES})
...
if(ecl_geometry_LIBRARIES)
  _remove_duplicate_libraries(ecl_geometry_LIBRARIES ecl_geometry_LIBRARIES)
endif()
