...
if(FALSE)
  set(ecl_mobile_robot_SOURCE_PREFIX C:/work/ecl/src/ecl_navigation/ecl_mobile_robot)
  set(ecl_mobile_robot_DEVEL_PREFIX C:/work/ecl/devel)
  ...
  set(ecl_mobile_robot_INSTALL_PREFIX C:/opt/overlay/groovy/x86)
...
if(NOT "C:/opt/overlay/groovy/x86/include" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    ...
    elseif(IS_DIRECTORY C:/opt/overlay/groovy/x86/${idir})
      ...
      message(FATAL_ERROR "Project 'ecl_mobile_robot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/opt/overlay/groovy/x86/${idir}'.  Ask the maintainer 'Daniel Stonier <d.stonier@gmail.com>' to fix it.")
    endif()
...
set(depends "ecl_errors;ecl_geometry;ecl_math;ecl_formatters;ecl_linear_algebra")
foreach(depend ${depends})
  ...
  list(APPEND ecl_mobile_robot_LIBRARIES ${${ecl_mobile_robot_dep}_LIBRARIES})
...
if(ecl_mobile_robot_LIBRARIES)
  _remove_duplicate_libraries(ecl_mobile_robot_LIBRARIES ecl_mobile_robot_LIBRARIES)
endif()
