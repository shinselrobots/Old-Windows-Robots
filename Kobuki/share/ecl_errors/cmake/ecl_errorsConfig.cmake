...
if(FALSE)
  set(ecl_errors_SOURCE_PREFIX C:/work/ecl/src/ecl_lite/ecl_errors)
  set(ecl_errors_DEVEL_PREFIX C:/work/ecl/devel)
  ...
  set(ecl_errors_INSTALL_PREFIX C:/opt/overlay/groovy/x86)
...
if(NOT "C:/opt/overlay/groovy/x86/include" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    ...
    elseif(IS_DIRECTORY C:/opt/overlay/groovy/x86/${idir})
      ...
      message(FATAL_ERROR "Project 'ecl_errors' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/opt/overlay/groovy/x86/${idir}'.  Ask the maintainer 'Daniel Stonier <d.stonier@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND ecl_errors_LIBRARIES ${${ecl_errors_dep}_LIBRARIES})
...
if(ecl_errors_LIBRARIES)
  _remove_duplicate_libraries(ecl_errors_LIBRARIES ecl_errors_LIBRARIES)
endif()
