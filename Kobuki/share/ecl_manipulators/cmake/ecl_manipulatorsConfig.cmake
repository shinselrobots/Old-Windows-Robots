...
if(FALSE)
  set(ecl_manipulators_SOURCE_PREFIX C:/work/ecl/src/ecl_manipulation/ecl_manipulators)
  set(ecl_manipulators_DEVEL_PREFIX C:/work/ecl/devel)
  ...
  set(ecl_manipulators_INSTALL_PREFIX C:/opt/overlay/groovy/x86)
...
if(NOT "C:/opt/overlay/groovy/x86/include" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    ...
    elseif(IS_DIRECTORY C:/opt/overlay/groovy/x86/${idir})
      ...
      message(FATAL_ERROR "Project 'ecl_manipulators' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/opt/overlay/groovy/x86/${idir}'.  Ask the maintainer 'Daniel Stonier <d.stonier@gmail.com>' to fix it.")
    endif()
...
set(depends "ecl_exceptions;ecl_geometry;ecl_formatters")
foreach(depend ${depends})
  ...
  list(APPEND ecl_manipulators_LIBRARIES ${${ecl_manipulators_dep}_LIBRARIES})
...
if(ecl_manipulators_LIBRARIES)
  _remove_duplicate_libraries(ecl_manipulators_LIBRARIES ecl_manipulators_LIBRARIES)
endif()
