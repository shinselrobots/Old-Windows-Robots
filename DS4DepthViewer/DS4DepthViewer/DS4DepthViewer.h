// DS4DepthViewer.h: DS4 camera handler interface
//////////////////////////////////////////////////////////////////////
...
// Constants
//static char *LogFileName = "c:\\temp\\RobotDepthLog.txt";
...
extern int InitIPC( HANDLE &hCommandEvent, LPCTSTR &pCommandBuf, HANDLE &DepthDataAvailableEvent, LPCTSTR &pStatusBuf );
